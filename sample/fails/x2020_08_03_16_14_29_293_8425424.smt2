...
(assert (! (forall ((?v0 S_v_tm$) (?v1 S_v_tm$)) (! (= (fun_app$ (fun_app$a uu$ ?v0) ?v1) (and (= (vars$ ?v0) bot$) (and (wary$ arity_sym$ arity_var$ ?v0) (and (wary$ arity_sym$ arity_var$ ?v1) (gt$ ground_heads_var$ gt_sym$ delta$ extf$ arity_sym$ wt_sym$ coef_sym$ ?v0 ?v1))))) :pattern ((fun_app$ (fun_app$a uu$ ?v0) ?v1)))) :named a0))
...
(assert (! (not (and (wary$ arity_sym$ arity_var$ (worst_chain$ uu$ uua$ (minus$ (plus$ i$ k2$) one$))) (and (wary$ arity_sym$ arity_var$ u$) (gt$ ground_heads_var$ gt_sym$ delta$ extf$ arity_sym$ wt_sym$ coef_sym$ (worst_chain$ uu$ uua$ (minus$ (plus$ i$ k2$) one$)) u$)))) :named a2))
(assert (! (and (wary$ arity_sym$ arity_var$ (worst_chain$ uu$ uua$ (minus$ (plus$ i$ k2$) one$))) (and (wary$ arity_sym$ arity_var$ (worst_chain$ uu$ uua$ (plus$ i$ k2$))) (gt$ ground_heads_var$ gt_sym$ delta$ extf$ arity_sym$ wt_sym$ coef_sym$ (worst_chain$ uu$ uua$ (minus$ (plus$ i$ k2$) one$)) (worst_chain$ uu$ uua$ (plus$ i$ k2$))))) :named a3))
...
(assert (! (and (wary$ arity_sym$ arity_var$ (worst_chain$ uu$ uua$ (plus$ i$ k2$))) (and (wary$ arity_sym$ arity_var$ u$) (gt$ ground_heads_var$ gt_sym$ delta$ extf$ arity_sym$ wt_sym$ coef_sym$ (worst_chain$ uu$ uua$ (plus$ i$ k2$)) u$))) :named a5))
(check-sat)
