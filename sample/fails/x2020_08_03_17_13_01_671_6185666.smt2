...
(assert (! (not (forall ((?v0 S_v_tm$)) (=> (member$ ?v0 (set$ (args$ ta$))) (= (vars$ ?v0) bot$)))) :named a0))
(assert (! (forall ((?v0 S_v_tm$) (?v1 S_v_tm$)) (=> (and (member$ ?v0 (set$ (args$ ?v1))) (= (vars$ ?v1) bot$)) (= (vars$ ?v0) bot$))) :named a1))
(assert (! (= (vars$ ta$) bot$) :named a2))
(check-sat)
